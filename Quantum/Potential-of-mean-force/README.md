...
* **I−(H2O)5 Dissociation:** *The figure below shows irreversible work distributions for the classical (red) and quantum (blue) systems in both forward and reverse directions. The intersection of the work distributions represents the free energy of dissociation, which is shifted in the quantum case compared to the classical system. Findings indicate that quantum effects contribute approximately 11% to the dissociation free energy, marking them as non-negligible components of cluster stability. This analysis demonstrates how protonic quantization alters the free energy landscape of small ion-water assemblies.*

<img src="./forward-reverse-work-distributions.jpg" width="500"/>

### Potential of Mean Force
* **Na+(H2O)12 Dissociation:** *The figure below shows the potential of mean force as a function of the cluster's radial distance for the classical and quantum systems. Significant quantum effects are identified in the potential of mean force, suggesting that quantization plays a critical role in the kinetics of ionic transport.*
