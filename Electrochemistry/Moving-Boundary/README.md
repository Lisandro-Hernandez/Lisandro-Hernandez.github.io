...
The moving boundary method was investigated through laboratory experiments in Dr. Hernández’s Electrochemistry course at Kettering University. The system shown in the images below corresponds to aqueous $\text{KNO}_3/\text{KMnO}_4$ solutions, illustrating the evolution of the electrolyte boundary during the experiment. The results demonstrate the progression of the interface between two electrolyte solutions, specifically highlighting both the displacement and sharpening of the moving boundary over time.
