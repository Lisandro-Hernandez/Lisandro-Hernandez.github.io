...
where the second term on the left represents advection (the physical displacement and sharpening of the boundary), and the term on the right represents diffusion (the natural mixing and dissipation of the gradient). In this model, $c$ indicates the concentration of the MnO<sub>4</sub><sup>-</sup> ion, while $1-c$ represents the concentration of the displaced NO<sub>3</sub><sup>-</sup> ion.
