...
The spectrum above corresponds to the Fourier transform of the following periodic quantum time correlation function of the lattice dynamics. The correlation function period is 3.17 ps, 
